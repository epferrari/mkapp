...
var NotifyBarBottom = React.createClass({
	...
	prepareStyles(){
		...
		let themeStyles =  merge({},this.getThemeStyles('notifyBar'),this.getThemeStyles('notifyBarBottom'));
...
export default NotifyBarBottom;
