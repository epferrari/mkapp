...
var NotifyBarTop = _react2.default.createClass({
	displayName: 'NotifyBarTop',
	...
	prepareStyles: function prepareStyles() {
		...
		var themeStyles = (0, _lodash.merge)({}, this.getThemeStyles('notifyBar'), this.getThemeStyles('notifyBarTop'));
