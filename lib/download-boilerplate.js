...
function promptConfigOverwrite(){
	return new Promise(function(resolve,reject){
		if(shell.test('-f','./config.js')){
			...
			console.log(clc.yellow('A config.js file already exists in your project. Overwrite it?'));
	...
	return promptBoilerplateDownload()
		...
		.then(function(){
			...
			return new Promise(function(resolve,reject){
				...
				var copied = shell.cp('-f',tmpdir+'/mkapp-master/config.js','./');
