 ...
 */
	...
	prepareStyles: function prepareStyles() {
		...
		if (this.state.didAnimate) {
			styles.menuItem = (0, _lodash.merge)({}, styles.menuItem, transitions.componentDidEnter);
		} else {
			styles.menuItem = (0, _lodash.merge)({}, styles.menuItem, transitions.componentWillEnter);
		}
		return styles;
	},
