...
var DrawerLeft = _react2.default.createClass({
  displayName: 'DrawerLeft',
  ...
  prepareStyles: function prepareStyles() {
    ...
    var themeStyles = (0, _lodash.merge)({}, this.getThemeStyles('drawer'), this.getThemeStyles('drawerLeft'));
