...
var DrawerBottom = _react2.default.createClass({
  displayName: 'DrawerBottom',
  ...
  prepareStyles: function prepareStyles() {
    ...
    var themeStyles = (0, _lodash.merge)({}, this.getThemeStyles('drawer'), this.getThemeStyles('drawerBottom'));
    var okStyles = ['backgroundColor', 'color', 'height', 'minHeight'];
