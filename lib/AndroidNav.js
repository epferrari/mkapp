...
var AndroidNav = _react2.default.createClass({
  displayName: 'AndroidNav',
  render: function render() {
    return _react2.default.createElement(_AppNav2.default, _extends({}, this.props, {
      menuPosition: 'left',
      materialDesign: true,
      menuStyle: (0, _lodash.merge)({}, androidMenuStyles, this.props.menuStyle) }));
  }
});

exports.default = AndroidNav;